import { Person } from "@/types/Person";  // const peopleList: Person[] = [  .. indica um array de perosn;
    ...
    {id: 2, name: 'Fulano2', profession: ',mathematician2'},
      {id: 3, name: 'Fulano3', profession: ',mathematician3'},
        {id: 4, name: 'Fulano4', profession: ',mathematician4'},
          {id: 5, name: 'Fulano5', profession: ',chemist'},
          {id: 6, name: 'Fulano6', profession: ',chemist'}
